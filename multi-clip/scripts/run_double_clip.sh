...
warmup_steps=500
kd_type=kd
run_name=xlmBase_p14_bs${bs}_wd${wd}_lr${lr}_ep${ep}_ws${warmup_steps}
...
CUDA_VISIBLE_DEVICES=0,1 WANDB_PROJECT=double-clip HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 python  \
