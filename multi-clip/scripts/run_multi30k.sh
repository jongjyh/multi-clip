...
WANDB_PROJECT=clip-kd HF_DATASETS_OFFLINE=0 TRANSFORMERS_OFFLINE=0 python run_clip.py \
    --output_dir ./clip-roberta-finetuned \
    --model_name_or_path ./clip-roberta \
    --dataset_name /sharefs/czz/datasets/multi30k/preproceed_dst \
    --image_column image \
    --caption_column de,fr,en,cs \
