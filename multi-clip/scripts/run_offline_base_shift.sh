...
bs=256
dst=/sharefs/czz/datasets/multi-clip/cc100k-zh 
run_name=baai/shift_base_base_${loss_fn}_${pooler_fn}_lkd${layer_kd}_loss${alpha}_wd${wd}_bs${bs}lr${lr}_ep${ep}_sd${seed}
CUDA_VISIBLE_DEVICES=0 WANDB_MODE=online HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 python multi-clip/multi-clip/run_translation.py  \
