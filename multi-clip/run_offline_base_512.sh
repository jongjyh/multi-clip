...
CUDA_VISIBLE_DEVICES=0 WANDB_MODE=online HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=0 python /home/chenzhongzhi/repo/multi-clip/multi-clip/run_translation.py  \
